...
#Configuration of Data Ingestion File
...
class DataIngestion:
    def __init__(self,data_ingestion_config:DataIngestionConfig):
        try:
            self.data_ingestion_config=data_ingestion_config   #By doing this it has access to all variables that were created in DataIngestionConfig
    ...
    def split_train_test_split(self,dataframe:pd.DataFrame):
        try:
            ...
            logging.info("Excited split_data as train test split")

            dir_path=os.path.dirname(self.data_ingestion_config.training_file_path)
            os.makedirs(dir_path,exist_ok=True)

            logging.info("Export tain and test file path")
